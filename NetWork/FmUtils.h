...
public:
	...
	unsigned short  YYConverUtf8ToUnicodeWithArray(TCHAR destUnicode[], int tcharLength, const char srcUtf8[]);
	int YYConverUtf8ToUnicode(TCHAR *destUnicode, const char* srcUtf8);
