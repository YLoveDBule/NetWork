...
static int tolua_luaNetWork_readByte(lua_State * tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 2)
	{
		...
		lua_pushinteger(tolua_S, (0x000000FF & sid[offset]));
		return 1;
	}
	return 0;
}

static int tolua_luaNetwork_readWord(lua_State * tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 2)
	{
		...
		int offset = (int)tolua_tonumber(tolua_S, 2, 0);
		BYTE temp[2] = { 0 };
		memcpy(temp, (void *)(sid + offset), 2);
		lua_pushinteger(tolua_S, *(WORD*)temp);
		return 1;
	}
	return 0;
}

static int tolua_luaNetwork_readShort(lua_State *tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 2)
	{
		...
		BYTE temp[2] = { 0 };
		memcpy(temp, (void *)(sid + offset), 2);
		lua_pushinteger(tolua_S, *(SHORT*)temp);
		return 1;
	}
	return 0;
}

static int tolua_luaNetwork_readInt(lua_State *tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 2)
	{
		...
		int offset = (int)tolua_tonumber(tolua_S, 2, 0);
		BYTE temp[4] = { 0 };
		memcpy(temp, (void *)(sid + offset), 4);
		lua_pushnumber(tolua_S, *(int*)temp);
		return 1;
	}
	return 0;
}

static int tolua_luaNetwork_readDword(lua_State *tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 2)
	{
		...
		BYTE temp[4] = { 0 };
		memcpy(temp, (void *)(sid + offset), 4);
		lua_pushnumber(tolua_S, *(DWORD*)temp);
		return 1;
	}
	return 0;
}

static int tolua_luaNetwork_readFloat(lua_State *tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 2)
	{
		...
		BYTE temp[4] = { 0 };
		memcpy(temp, (void *)(sid + offset), 4);;
		lua_pushnumber(tolua_S, *(float*)temp);
		return 1;
	}
	return 0;
}

static int tolua_luaNetwork_readDouble(lua_State *tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 2)
	{
		...
		int offset = (int)tolua_tonumber(tolua_S, 2, 0);
		BYTE temp[8] = { 0 };
		memcpy(temp, (void *)(sid + offset), 8);;
		lua_pushnumber(tolua_S, *(double*)temp);
		return 1;
	}
	return 0;
}

static int tolua_luaNetwork_readBoolen(lua_State *tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 2)
	{
		...
		int offset = (int)tolua_tonumber(tolua_S, 2, 0);
		BYTE temp[1] = { 0 };
		memcpy(temp, (void *)(sid + offset), 1);
		lua_pushnumber(tolua_S, *temp);
		//lua_pushboolean(tolua_S, temp == 0 ? 0 : 1);
		return 1;
	}
	return 0;
}

static int tolua_luaNetwork_readScore(lua_State *tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 2)
	{
		...
		BYTE temp[8] = { 0 };
		memcpy(temp, (void *)(sid + offset), 8);
		lua_pushnumber(tolua_S, *(long long*)temp);
		return 1;
	}
	return 0;
}

static int tolua_luaNetwork_readString(lua_State *tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 3)
	{
		...
		int offset = (int)tolua_tonumber(tolua_S, 2, 0);
		int size = (int)tolua_tonumber(tolua_S, 3, 0);
		char *buff = sid + offset;
		char *temp = new(std::nothrow) char[size + 1];
		memset(temp, 0, size);
		CN2Ttf8(buff, temp, size);
		if (temp)
		{
			lua_pushstring(tolua_S, temp);
		}
		else
		{
			lua_pushstring(tolua_S, buff);
...
static int tolua_luaNetwork_readTchar(lua_State *tolua_S)
{
	int arrgc = lua_gettop(tolua_S);
	if (arrgc == 3)
	{
		...
		int offset = (int)tolua_tonumber(tolua_S, 2, 0);
		int size = (int)tolua_tonumber(tolua_S, 3, 0);
		char*	pszDstData = new(std::nothrow) char[1024];
		TCHAR*	pszSrcData = new(std::nothrow) TCHAR[size + 1];
		memset(pszDstData, 0, 1024);
		memset(pszSrcData, 0, size * 2 + 2);
		memcpy(pszSrcData, sid + offset, size * 2);
		FmUtils::getInstance()->ToClientString((char*)pszSrcData, size * 2, pszDstData, 1024);
...
int register_all_luaNetWorkEx(lua_State* tolua_S)
{
	...
	tolua_function(tolua_S, "lua_byte2byte", tolua_luaNetWork_readByte);
	tolua_function(tolua_S, "lua_byte2word", tolua_luaNetwork_readWord);
	tolua_function(tolua_S, "lua_byte2string", tolua_luaNetwork_readString);
	tolua_function(tolua_S, "lua_byte2int", tolua_luaNetwork_readInt);
	tolua_function(tolua_S, "lua_byte2tchar", tolua_luaNetwork_readTchar);
	tolua_function(tolua_S, "lua_byte2float", tolua_luaNetwork_readFloat);
	tolua_function(tolua_S, "lua_byte2short", tolua_luaNetwork_readShort);
	tolua_function(tolua_S, "lua_byte2double", tolua_luaNetwork_readDouble);
	tolua_function(tolua_S, "lua_byte2bool", tolua_luaNetwork_readBoolen);
	tolua_function(tolua_S, "lua_byte2score", tolua_luaNetwork_readScore);
	tolua_function(tolua_S, "lua_byte2dword", tolua_luaNetwork_readDword);
	return 1;
}
