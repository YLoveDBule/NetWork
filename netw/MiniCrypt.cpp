...
void CMiniCryptDes::ZES_set_key(const_ZES_cblock *key,ZES_key_schedule *schedule)
{
...
void CMiniCryptDes::ZES_encrypt1(ZES_LONG *data,ZES_key_schedule *ks1,int enc){
...
void CMiniCryptDes::ZES_encrypt2(ZES_LONG *data,ZES_key_schedule *ks,int enc)
{
	register ZES_LONG l,r,t,u;
#ifdef ZES_PTR
...
void CMiniCryptDes::ZES_encrypt3(ZES_LONG *data,ZES_key_schedule *ks1,
...
void CMiniCryptDes::ZES_decrypt3(ZES_LONG *data,ZES_key_schedule *ks1,
				  ZES_key_schedule *ks2,ZES_key_schedule *ks3)
{
	register ZES_LONG l,r;
...
int CMiniCryptDes::ZES_is_weak_key(const_ZES_cblock *key)
{
	int i;
...
void CMiniCryptDes::ZES_set_odd_parity(ZES_cblock *key)
{
	unsigned long i;
...
void CMiniCryptDes::ZES_random_key(ZES_cblock *ret)	
{
	...
	{		
		for (i=0; i<sizeof(ZES_cblock); i++)
			(*ret)[i] = (unsigned long)(255.0*rand()/(RAND_MAX+1.0));
		/*
...
void CMiniCryptDes::RC5_32_set_key(RC5_32_KEY *key,int len,const unsigned char *data,
		    int rounds)
	{
...
void CMiniCryptDes::RC5_32_encrypt(RC5_32_INT *d,RC5_32_KEY *key)
	{
		RC5_32_INT a,b,*s;
...
void CMiniCryptDes::RC5_32_decrypt(RC5_32_INT *d,RC5_32_KEY *key)
	{
		RC5_32_INT a,b,*s;
